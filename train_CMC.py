...
def get_train_loader(args):
	...
	# These color transforms do not change the number of image channels, instead they
	# redefine the channels themselves
	# if args.view == 'Lab':
	...
	# returns the image index as well i.e.:
	# train_dataset[i] -> (PIL image object, class index, i)
